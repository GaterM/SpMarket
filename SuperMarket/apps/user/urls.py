...
from user.views import LoginView, RegisterView, CenterView, InfoView, LogoutView, AddressView, SendCodeView, upload_head
...
urlpatterns = [
    ...
    url(r'^head_load/$', upload_head, name='head'),  # 上传头像
]